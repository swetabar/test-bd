...
/**
 * Transformer: gct.com Dynamic Media / Scene7 images.
 * Converts DM/Scene7 <img> tags into anchors that round-trip through markdown;
 * the companion auto-block in scripts/scripts.js rebuilds them as responsive
 * <picture> at render time. Source uses grandcircle.scene7.com/is/image/ URLs.
 *
 * Runs in afterTransform ONLY: block parsers run between the hooks and extract
 * <img> references into block cells (cards/carousel/columns); rewriting imgs
